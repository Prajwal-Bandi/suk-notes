...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    ...
    toastr.success("Welcome to SUK-NOTES Dashboard", "Howdy!");
  }
  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Welcome to SUK-NOTES", " Info message");
      } else if (thisId === "toaster-success") {
        toastr.success("Welcome to SUK-NOTES", "Success message");
      } else if (thisId === "toaster-warning") {
        toastr.warning("Welcome to SUK-NOTES", "Warning message");
      } else if (thisId === "toaster-danger") {
        toastr.error("Welcome to SUK-NOTES", "Danger message");
      }
    });
  }
